...
- **codex 모드**: 참여 중인 AI 모두 근거 있는 "수정 없음" 선언, 또는 5회 이상 토론 후 주요 쟁점 해결
- **solo 모드**: 검증자가 근거 있는 "수정 없음" 선언, 또는 5회 이상 검토 후 주요 쟁점 해결
- **dual 모드**: 참여 중인 AI 모두 근거 있는 "수정 없음" 선언, 또는 5회 이상 토론 후 주요 쟁점 해결
