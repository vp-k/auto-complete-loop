...
- [ ] 로깅/모니터링 요구사항이 포함되어 있는가? (해당 시 — `docs/logging-standard.md`가 없는 Small 프로젝트는 SPEC의 해당 섹션)
...
**조건부 완성도 (projectScope 기반 — progress 파일에 `projectScope`가 없으면(`/plan-docs-auto`) 문서 내용으로 백엔드/프론트 여부를 판단한다):**
